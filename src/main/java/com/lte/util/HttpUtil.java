...
public class HttpUtil 
{
	 ...
	 * @throws Exception 
	 */
	public static String post(Wallet wallet, String parameters) throws Exception {
		return HttpUtil.post(wallet, parameters, "UTF-8");
	}
	 ...
	 * @throws Exception
	 */
	public static String post(Wallet wallet, String parameters, String encode) throws Exception {
		StringBuffer stringBuffer = new StringBuffer();
		...
		try {
			...
			if (wallet.getUrl().toLowerCase().startsWith("https://")) {
				setHttpsURLConnection();
			}
			httpConnection = (HttpURLConnection) url.openConnection();
